...
class RoleView extends egret.Sprite{
	...
	public constructor(roleName:string) {
		...
		this.m_role.addEventListener(egret.MovieClipEvent.COMPLETE, this.onComplete, this);
	}
	...
	public setState(state:RoleState, callback:Function, thisObj:any){
	...
	private onComplete(e:egret.MovieClipEvent){
