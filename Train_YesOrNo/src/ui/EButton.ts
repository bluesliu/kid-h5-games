...
class EButton extends egret.Sprite {
    ...
    */
    public constructor(context: any, imgName: string, beginFun: Function = null, endFun: Function = null, descStr: string = "", fontSize: number = 30, cartoonType: number = 1, assetsName: string = null) {
        super();
    ...
    private init(imgName: string, beginFun: Function = null, endFun: Function = null,descStr: string = "", fontSize: number = 30, cartoonType: number = 1, assetsName: string = null): void {
