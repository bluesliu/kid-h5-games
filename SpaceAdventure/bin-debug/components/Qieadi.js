...
var Qieadi = (function (_super) {
    ...
    Qieadi.prototype.initContent = function () {
        //     
        var qwd0 = this.createBitmapByName("奇瓦迪_png");
        var qwd1 = this.createBitmapByName("success_0_png");
        var qwd2 = this.createBitmapByName("fail_1_png");
        var qwd3 = this.createBitmapByName("qwd2_png");
        var qwd4 = this.createBitmapByName("qwd3_png");
        this.addChild(qwd0);
        this.addChild(qwd1);
        qwd1.x = 45;
        qwd1.y = -66;
