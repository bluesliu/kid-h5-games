...
(function (RoleState) {
    ...
    RoleState[RoleState["shoot"] = 1] = "shoot";
    RoleState[RoleState["happy"] = 2] = "happy";
    RoleState[RoleState["sad"] = 3] = "sad";
    RoleState[RoleState["dance"] = 4] = "dance";
    RoleState[RoleState["dance_mouth"] = 5] = "dance_mouth";
    RoleState[RoleState["celebrate"] = 6] = "celebrate";
    RoleState[RoleState["fail"] = 7] = "fail";
    RoleState[RoleState["fail_mouth"] = 8] = "fail_mouth";
})(RoleState || (RoleState = {}));
var RoleView = (function (_super) {
    ...
    RoleView.prototype.shoot = function () {
        this.m_role.gotoAndStop(RoleState[RoleState.shoot]);
    };
    ...
    RoleView.prototype.dance = function () {
        this.m_role.gotoAndStop(RoleState[RoleState.dance]);
    };
    RoleView.prototype.dance_mouth = function () {
        this.m_role.gotoAndPlay(RoleState[RoleState.dance_mouth], -1);
    };
    ...
    RoleView.prototype.fail = function () {
        this.m_role.gotoAndStop(RoleState[RoleState.fail]);
    };
    RoleView.prototype.fail_mouth = function () {
